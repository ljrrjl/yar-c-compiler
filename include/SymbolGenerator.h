...
public:
	...
	virtual std::shared_ptr<Sentence> generate() override;
private:
	std::shared_ptr<Sentence> unpack_map_generate(std::shared_ptr<Symbol> symbol) { return nullptr; }
	std::shared_ptr<Sentence> pack_map_generate(std::shared_ptr<Symbol> symbol) {return nullptr;}
};
